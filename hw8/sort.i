...
# 1 "/usr/lib/gcc/x86_64-redhat-linux/5.3.1/include/stddef.h" 1 3 4
# 328 "/usr/lib/gcc/x86_64-redhat-linux/5.3.1/include/stddef.h" 3 4
...
int main(void)
{
 test(tiny, (sizeof(tiny) / sizeof((tiny)[0])));
 test(random, (sizeof(random) / sizeof((random)[0])));
 test(ascending, (sizeof(ascending) / sizeof((ascending)[0])));
